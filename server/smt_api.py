...
lib.BatchWrite.argtypes = [c_char_p, GoSlice, GoSlice]	
...
def batch_insert(prefix, keys, values) -> str:
	...
	root = lib.BatchWrite((c_char_p)(prefix.encode()), ids, digests)
	print(root)
	return root.decode()
